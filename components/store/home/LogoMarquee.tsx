  ...
  return (
    <div className="flex h-16 w-auto min-w-[120px] items-center justify-center p-2">
      <Image
        ...
        width={140}
        height={56}
        className="h-10 md:h-14 w-auto max-w-[100px] md:max-w-[150px] object-contain opacity-80 hover:opacity-100 dark:opacity-70 dark:hover:opacity-100 transition-all duration-300 motion-reduce:transition-none"
